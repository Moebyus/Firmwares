...
// @section lcd
  ...
  #define MANUAL_FEEDRATE {80*60, 80*60, 10*60, 6*60} // Feedrates for manual moves along X, Y, Z, E from panel
...
#define FILAMENT_CHANGE_FEATURE
  ...
  #define FILAMENT_CHANGE_X_POS 25            // X position of hotend
  ...
  #define FILAMENT_CHANGE_LOAD_LENGTH   35    // Load filament length over hotend in mm
